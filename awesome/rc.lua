...
-- require("/home/max/.config/awesome/theme/theme.lua")
...
local test = require("my_widgets.test")
...
-- beautiful.init("/home/max/.config/awesome/themes/blackburn/theme.lua")
-- beautiful.init("/home/max/.config/awesome/theme/uno/theme.lua")
beautiful.init("/home/max/.config/awesome/uno/theme.lua")
-- beautiful.init(string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), chosen_theme))
-- beautiful.init("awesome_copycats/themes/multicolor/theme.lua")
...
local function set_wallpaper(s)
  ...
  if beautiful.wallpaper then
    ...
    -- gears.wallpaper.maximized("/home/max/Pictures/dark-anime-girl-ruby-rose.jpg", s, true)
    gears.wallpaper.maximized("/home/max/Pictures/penguin2.jpg", s, true)
    -- gears.wallpaper.maximized("usr/share/backgrounds/Lunar-lobster-side_by_Gixo-dark.png", s, true)
  end
end
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, "Control" }, "Up", function()
    os.execute("python3 ~/brightness_changer.py +0.05")
  end),
  ...
  awful.key({ modkey, "Control", "Shift" }, "p", function()
    -- gears.wallpaper.maximized("/home/max/Pictures/dark-anime-girl-ruby-rose.jpg", s, true)
    os.execute("feh --bg-scale ~/Pictures/dark-anime-girl-ruby-rose.jpg")
    -- awesome.restart()
  end),
  awful.key({ modkey, "Shift" }, "b", function()
    os.execute("i3lock -i Pictures/cat.png -t")
  end),

  awful.key({ modkey, "Control" }, "l", function()
    os.execute("feh --bg-scale ~/Pictures/fedora.jpg")
  end),
  ...
  awful.key({ modkey, }, "Down", function() awful.util.spawn("amixer set 'Master' 10%-") end,
  ...
  awful.key({ modkey, "Shift" }, "Return", function() awful.spawn("xfce4-terminal") end,
    { description = "open xfce4-terminal", group = "launcher" }),
  ...
  awful.key({}, "Print",
    function()
      os.execute(
      -- "scrot -s /home/max/Pictures/Screenshots/%b%d::%H%M%S.png -e 'xclip -selection clipboard -t image/png -i $f'")
        "scrot /home/max/Pictures/Screenshots/%b%d::%H%M%S.png -a $(slop -f '%x,%y,%w,%h') -e 'xclip -selection clipboard -t image/png -i $f'")
    end),
  awful.key({ modkey }, "Print",
    function()
      awful.util.spawn(
        "scrot /home/max/Pictures/Screenshots/%b%d::%H%M%S.png -e 'xclip -selection clipboard -t image/png -i $f'")
    end),
  awful.key({ modkey }, "x",
    function()
      awful.prompt.run {
